                ...
                <div className="container">
                    ...
                    <div className="live-now-rail">
                        {liveRailEvents.length > 0 ? (
                            ...
                            ["Neustadt", "Pieschen", "Gro?er Garten", "Radeberg"].map((spot) => (
                    ...
                    <div className="hidden-gem-card__copy">
                        ...
                        <p>
                            {hiddenGem
                                ...
                                : "\"Sobald die ersten Nischen-Events live sind, bekommen sie hier die große Buehne.\""}
                        </p>
                        {hiddenGem ? (
